...
func TestResolveEndpoints_canonicalizesResourceURLWithoutDiscovery(t *testing.T) {
	tests := []struct {
		name string
		url  string
		want string
...
func TestResolveEndpoints_rejectsInvalidResourceURLWithoutDiscovery(t *testing.T) {
	tests := []struct {
		name string
		url  string
	}{
