...
mini pipe list                            List loaded pipes (experimental; requires enable_pipes: true)
mini pipe run NAME [--args '{"k":"v"}']   Run a pipe directly (experimental; requires enable_pipes: true)
mini pipe check [NAME]                    Validate pipe YAML and expressions (experimental; requires enable_pipes: true)
```
