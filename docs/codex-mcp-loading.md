...
`mini connect` (proxy) is the default and works everywhere. Codex defers schemas once
it crosses 100 tools, so proxy costs nothing upfront at scale. Below that threshold
